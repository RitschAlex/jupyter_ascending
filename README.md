...
was limited to Jupyter Notebook v6.x. This fork updates the codebase to keep the project alive and extends support to:

- **Jupyter Notebook nbclassic** (classic notebook interface)
- **Jupyter Notebook v7+** (modern notebook interface, built on jupyter-server)
- **JupyterLab** (full IDE-like interface, shares the same jupyter-server backend as Notebook v7+)
